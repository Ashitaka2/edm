...
@click.option('--num_timesteps',    help='# of LoRA time adapters',                                   type=int,  default=None,    show_default=True)
@click.option('--num_augments',     help='# of LoRA augment adapters',                                type=int,  default=None,    show_default=True)
